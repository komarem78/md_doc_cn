...
slug: /java-spring-boot-complex-examples/java-spring-boot-rest-api-and-kafka-message-publishing
---
...
- Prepare your local development environment for CodeNOW with Java Spring Boot. 
  - Follow the tutorial instructions in [Java Spring Boot Local Development](../locDevWitCodNow/locDev/).
- Run Apache Kafka locally. 
  - Use docker compose as described in the section *Docker compose and third-party tools* of the [Java Spring Boot Local Development](../locDevWitCodNow/locDev/) tutorial.
...
- Next prepare the configuration for the Kafka logging client:
  - Go to the Kafka administration console ([http://localhost:9000](http://localhost:9000/) if using Kafdrop from our [Java Spring Local Development](../locDevWitCodNow/locDev/) manual.) and create a new topic **client-logging**
...
- Check [Get New Apache Kafka](../manComAdm/getNewApaKaf/) for setup in the CodeNOW environment.
