...
slug: /java-micronaut-examples/java-micronaut-rest-server-with-postgresql
---
...
- Run PostgreSQL locally. 
  ...
  - Configuration file for docker-compose can be downloaded from the link that can be found in the section *Docker compose and third-party tools* of the [Java Micronaut Local Development](../locDevWitCodNow/locDev/) tutorial.
...
- Try to build and run the application in your IDE. After startup, you should be able to access your new controller’s swagger: [http://localhost:8080/swagger/index.html](http://localhost:8080/swagger/index.html)
  - For correct setup, check Readme.md in project root or see the tutorial [Java Micronaut Local Development](../locDevWitCodNow/locDev/), section *Prepare local development IDE*
...
- See the tutorial [Micronaut REST server with Redis and Kafka](../javMicExa/micResSerRedAndKaf/).