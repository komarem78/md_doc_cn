...
slug: /admin-manuals/create-new-application-component
---
...
- Choose the existing application or [Create a New Application](../admMan/creNewApp/).
...
1. See the application detail and create a new application component.
    ...
    - Creating a managed component is another use case:
      - [Get New Redis](../manComAdm/getNewRed/)
      - [Get New PostgreSQL](../manComAdm/getNewPos/)
      - [Get New Kafka](../manComAdm/getNewApaKaf/)


2. Clone the Git repository using your favourite Git management tool. Use your personal [SSH key](../useAdm/sshSet/) and start the local development.
